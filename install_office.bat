...
if "%MODE%"=="1" (
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -Command "Start-Sleep -Seconds 3; while (Get-Process | Where-Object { $_.SI -gt 0 -and ($_.ProcessName -like '*Office*' -or $_.ProcessName -like '*C2R*') }) { Start-Sleep -Seconds 2 }"
) else if "%MODE%"=="2" (
